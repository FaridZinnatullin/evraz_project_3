...
def test__on_get_user_info(client, users_service):
    ...
    result = client.simulate_get(f'/api/users/user_info', params=params, headers=headers)
...
def test__on_post_registration(client, users_service):
    ...
    result = client.simulate_post(f'/api/users/registration', body=json.dumps(user_media))
